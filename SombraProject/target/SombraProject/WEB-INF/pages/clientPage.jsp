    		 ...
    		 <c:forEach var="categoryList" items="${categoryList}" varStatus="status">
	    		<div class="col-sm-4">
	    			<div align="center" class="col-sm-12">
						<a href="${pageContext.request.contextPath}/client/choosedCategory?categoryID=${categoryList.categoryID}"><img src="${categoryList.categoryImg}" class="img-thumbnail" width="100%" height="170" ></a>
					</div>
					<div align="center" class="col-sm-12">
